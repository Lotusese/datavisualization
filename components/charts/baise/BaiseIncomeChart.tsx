  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Area 
          type="monotone" 
          dataKey="cityRuralIncome" 
          name="全市农村居民收入"
          stroke={CHART_COLORS.gold} 
          fill="url(#colorCityIncome)" 
          strokeWidth={3}
        />
        <Area 
          type="monotone" 
          dataKey="borderRuralIncome" 
          name="边境县居民收入"
          stroke={CHART_COLORS.red} 
          fill="url(#colorBorderIncome)" 
          strokeWidth={3}
        />
      </AreaChart>
    </ResponsiveContainer>
